...
{
    /**
     * Глобальный HTTP-стек промежуточного программного обеспечения приложения.
     *
    ...
    /**
     * Промежуточное ПО маршрута приложения.
     *
     * Это промежуточное ПО может быть назначено группам или использоваться индивидуально.
     *
     * @var array
     */
